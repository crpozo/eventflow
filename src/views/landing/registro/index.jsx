          ...
          <>
            ...
            >
              {ticketsArray.map((_, index) => (
                ...
                >
                  <div className="flex w-full max-w-[360px]  items-center justify-start bg-gray-100 px-2 pb-2">
                    <div className="ticket-bg flex w-full flex-col items-center justify-between gap-24 px-4 pb-3 pt-12">
                      ...
                      <div className="items-right flex w-full flex-col justify-end">
                        {userData.map((data, i) => (
                          <div key={i}>
                            {data.name == "text-1692266990765-0" && (
                              <p className="mb-1 w-full text-right text-sm font-bold">
                                {data.userData[0]}
                              </p>
                            )}
                        ...
                        <p className="mb-1 text-right text-xs font-normal">
                          Universidad San Francisco de Quito, Campus Cumbayá
                        </p>
                        <p className="l-auto mb-1 ml-auto max-w-fit bg-black px-1 py-[2px] text-right text-xs font-normal text-white">

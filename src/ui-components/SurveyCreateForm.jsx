...
export default function SurveyCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setSendAt(initialValues.sendAt);
    setSentAt(initialValues.sentAt);
    setInsights(initialValues.insights);
    setInsightsAt(initialValues.insightsAt);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          const survey = await DataStore.save(new Survey(modelFields));
          const promises = [];

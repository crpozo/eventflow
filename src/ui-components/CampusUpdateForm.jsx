...
export default function CampusUpdateForm(props) {
  const {
    id: idProp,
    campus: campusModelProp,
    onSuccess,
    onError,
    onSubmit,
    onCancel,
  ...
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(Campus, idProp)
        : campusModelProp;
      setCampusRecord(record);
    };
    queryData();
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            Campus.copyOf(campusRecord, (updated) => {
      ...
      {...getOverrideProps(overrides, "CampusUpdateForm")}
      {...rest}
    >
      <TextField
        label={

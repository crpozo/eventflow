...
export default function SurveyResponseUpdateForm(props) {
  ...
  const resetStateValues = () => {
    const cleanValues = surveyResponseRecord
      ...
      : initialValues;
    setSurveyID(cleanValues.surveyID);
    setEventID(cleanValues.eventID);
    setToken(cleanValues.token);
    setAnswers(
      typeof cleanValues.answers === "string" || cleanValues.answers === null
        ? cleanValues.answers
        : JSON.stringify(cleanValues.answers)
    );
    setErrors({});
  };
  ...
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(SurveyResponse, idProp)
        : surveyResponseModelProp;
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            SurveyResponse.copyOf(surveyResponseRecord, (updated) => {
